...
const ListarDisciplinas = () => {
  const [disciplinas, setDisciplinas] = useState([
    { id_discip: 1, enunciado: "Sublinhe as palavras corretas: ", qtd_dias: 5, num_fase: 1 },
    { id_discip: 2, enunciado: "Marque os as alternativas verdadeiras: ", qtd_dias: 4, num_fase: 2 },
  ...
  const openEditModal = (disciplina) => {
    ...
    setNewDisciplina(disciplina.enunciado);
        ...
        {disciplinas.map((disciplina) => (
          <li className="lista-disciplinas" key={disciplina.id_discip}>
            ...
            <div className="buttons-lista">
              ...
              >
                <p className="paragrafo">Editar</p>
              </button>
              <button
                className="button-excluir"
                onClick={() => openDeleteModal(disciplina.id_discip)}
              >
                <p className="paragrafo">Excluir</p>
              </button>
            </div>
          </li>
        ))}
